...
import { travelPodcastsData } from '../../data/travelData';

export default function TravelPodcasts() {
  return (
    <div className="mb-16 md:mb-24">
      ...
      {travelPodcastsData.podcasts.map((podcast) => (
        <ScrollReveal key={podcast.title}>
          <a
            href={podcast.url}
            target="_blank"
          ...
          >
            <OrganicCard className="transition-all duration-300">
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary to-primary-container flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <h4 className="font-heading text-lg text-on-surface mb-2 group-hover:text-primary-container transition-colors italic">
                    {podcast.title}
                  </h4>
