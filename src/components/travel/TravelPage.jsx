    ...
    <section id="travel" className="py-16 md:py-22 bg-surface-dim">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        <SectionHeading
          ...
          subtitle="Creating opportunities and inspiring access to the outdoors as a hiker, runner, mountaineer, Wilderness First Responder, and founder of the largest adventure company for Muslims."
        />
        <MawaCollective />
        <TechVineDivider />
